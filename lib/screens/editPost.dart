...
class EditPostScreen extends StatefulWidget {
  final ThreadPost postToEdit;
  final Thread thread;
  final List<ThreadPost> replyList;

  EditPostScreen({this.postToEdit, this.thread, this.replyList});
...
class _EditPostScreenState extends State<EditPostScreen> {
  ...
  void initState() {
    super.initState();
    this.document = this.widget.postToEdit.content;
  }
  ...
  void onPressPost() async {
    ...
    await KnockoutAPI()
        .updatePost(document.toJson(), this.widget.postToEdit.id, this.widget.thread.id)
        .catchError((error) {
      print(error);
    });
